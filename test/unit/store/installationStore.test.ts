...
describe('Installation Store', () => {
  ...
  describe('Installation Flow Integration', () => {
    it('should handle successful installation flow', async () => {
      ...
      // initState is set to 'done' by useInstallationSetup after backend is ready,
      // not by performInstallation directly.
      expect(mockSetInitState).not.toHaveBeenCalled()
    })
